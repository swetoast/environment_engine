...
from .const import (
    ...
    OPT_AIR_RECOVERY, OPT_AQI_THRESHOLD, OPT_AUTO_APPLY, OPT_FILTER_LIFE, OPT_PORTABLE_AC, OPT_VENT_REVERT, OPT_CO2_THRESHOLD, OPT_CO2_VENTILATE, OPT_COMPRESSOR_MIN_CYCLE, OPT_DEVICE_MIN_CYCLE, OPT_FORECAST_PRECOOL, OPT_QUIET_HOURS, OPT_QUIET_START, OPT_QUIET_END, OPT_QUIET_MAX_TEMP, OPT_IONIZER_MODE, OPT_HUMIDITY_SENSITIVITY, OPT_AWAY_MAX_DRIFT, OPT_COIL_DRY_OUT,
    OPT_DEWPOINT_MARGIN, OPT_FAN_COMFORT, OPT_HUMIDITY_COMFORT, OPT_HUMIDITY_COOLING, OPT_LUX_THRESHOLD,
    OPT_LIGHTNING_DISTANCE, OPT_MIN_CHANGE_INTERVAL, OPT_OUTDOOR_AQI_THRESHOLD, OPT_POLLEN_THRESHOLD, OPT_PM10_THRESHOLD, OPT_PM25_THRESHOLD, OPT_PRESENCE_HOLD,
...
_GLOBAL_NUMBER_OPTIONS = (
    ...
    (OPT_POLLEN_THRESHOLD, dict(min=0.5, max=20, step=0.5, unit_of_measurement="grains/m³")),
