...
**Cooling that thinks ahead.** It targets how the room *feels* (a bounded heat index, so a muggy
24 °C is treated like a warmer room), learns how fast the room actually gains and sheds heat, and
starts cooling *before* it needs to when it knows the room warms quickly.
